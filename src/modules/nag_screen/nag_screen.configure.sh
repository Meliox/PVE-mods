#!/usr/bin/env bash
# nag_screen.configure.sh - Configure module for pve-mods nag_screen
#
# Sourced by pve-mods-configure. Requires CONFD_DIR to be defined in the
...
#   nag_screen_write_conf  — write placeholder /etc/pve-mods/conf.d/nag_screen.conf
...
# pve-mods :: nag_screen mod configuration
